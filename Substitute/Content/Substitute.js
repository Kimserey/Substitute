...
(function()
{
 var Global=this,Runtime=this.IntelliFactory.Runtime,UI,Next,Doc,Substitute,Root,Client;
 Runtime.Define(Global,{
  Substitute:{
   Client:{
    Main:Runtime.Field(function()
    {
     return Doc.RunById("main",Root.page());
    })
   }
  }
 });
 Runtime.OnInit(function()
 {
  ...
  Doc=Runtime.Safe(Next.Doc);
  Substitute=Runtime.Safe(Global.Substitute);
  Root=Runtime.Safe(Substitute.Root);
